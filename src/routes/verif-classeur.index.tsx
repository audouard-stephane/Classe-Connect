...
export const Route = createFileRoute("/verif-classeur/")({
  component: VerifClasseurLanding,
  head: () => ({
    meta: [{ title: "A son classeur — ClasseScan" }],
  }),
});

function VerifClasseurLanding() {
  ...
  return (
    <AppShell title="A son classeur" subtitle="Choisissez une classe">
      ...
      >
        <BookOpen className="size-6" /> Ouvrir le plan
      </Button>
    </AppShell>
  );
}